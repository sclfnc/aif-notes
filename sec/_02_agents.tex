...
\begin{example}[Vacuum-cleaner world]\label{ex:vacuum-world}
  This worked example runs through the section. A vacuum cleaner moves between
  two squares, \textsf{A} and \textsf{B}.
...
agent needs a criterion. Most definitions of AI ask the agent to do ``the right
thing'' and never mention intelligence: this narrows the field, but it makes the
goal precise enough to build agents toward it.
...
optimal solution, so it encourages the agent to learn one fixed behavior. The
